Forked for my own use, pair code 1234, colors changes, custom logo and some extra gauges. works for my cyd 2.8 tft resistive. Online flash tool is for the original not mine. needs screen calibration. touch control are left/right cycle screen and menus, center screen hold for 3 sec opens config/activate in menu.
